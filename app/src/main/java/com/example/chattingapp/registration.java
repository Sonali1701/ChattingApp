        ...
        rg_signup.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                if (TextUtils.isEmpty(namee) || TextUtils.isEmpty(emaill) || TextUtils.isEmpty(Password) ||
                    ...
                    Toast.makeText(registration.this, "Invalid Information", Toast.LENGTH_SHORT).show();
                } else if (!emaill.matches(emailPattern)) {
                    progressDialog.dismiss();
                    rg_email.setError("Type a valid email");
                } else if (Password.length() < 8) {
                    progressDialog.dismiss();
                    rg_password.setError("Password must be 8 Character");
                } else if (!Password.equals(cPassword)) {
                    progressDialog.dismiss();
                    rg_password.setError("The passsword doesn't match");
                } else {
